...
class Page4Cont: SKScene {
    ...
    override public func didMove(to view: SKView) {
        ...
        let action = SKAction.changeColor(startColor: SKColor(red: 252/255, green: 220/255, blue: 167/255, alpha: 1.0), endColor: SKColor(red: 255/255, green: 248/255, blue: 248/255, alpha: 1.0), duration: 1.5)
        self.run(action)
        initalSetup()
    }
